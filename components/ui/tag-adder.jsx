...
const TagAdder = (onClick ) => { 
    return (
        <>
            <div className="flex w-[140px] h-8 relative m-1 items-center justify-center 
            ...
            border-primary focus-visible:ring-1 focus-visible:ring-ring focus-visible:ring-offset-1 ">
                ...
                <div className="flex w-3/4 flex-col text-white text-x font-semibold font-['Inter']">tag to add</div>
            </div>
        </>
    )
}
